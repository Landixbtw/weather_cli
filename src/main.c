    ...
    */
    ...
    if (current != NULL) {
        ...
        if (cJSON_IsString(observation_time) && (observation_time->valuestring != NULL)) {
            fprintf(stdout, "\n\033[4mObservation Time:\033[0m %s.\n", observation_time->valuestring);
        }
